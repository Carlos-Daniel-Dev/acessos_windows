...
# com a engrenagem e o olho no Windows: nem Calibri nem IBM Plex Sans
# (que nao vem instalada la) trazem esses pontos de codigo. O redesign
# adota tema de icones simbolico (Gtk.IconTheme) como caminho principal,
# mas o texto/emoji continua sendo o FALLBACK quando o tema de icones nao
# tem o nome pedido — e e exatamente esse fallback que precisa do glifo
# aparecendo de verdade no Windows.
#
...
MONO = '"IBM Plex Mono", "Consolas", "DejaVu Sans Mono", monospace, ' + SIMBOLOS
